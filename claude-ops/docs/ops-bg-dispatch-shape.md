...
`ops-bg` sessions inherit **all** SessionStart hooks — including the my-project monitoring
...
my-project SessionStart monitoring briefing. Agent responded to the briefing output instead
