...
to be billing AWS Bedrock** (metered per-token spend, not the Max OAuth account
...
When OAuth headroom exists, the watchdog respawns the session onto OAuth and
