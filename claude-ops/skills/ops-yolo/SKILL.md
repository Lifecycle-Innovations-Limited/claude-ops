---
name: ops-yolo
description: "This skill should be used when the user asks to \"/ops:ops-yolo\", \"run ops-yolo\", or \"use ops-yolo\". YOLO mode. Spawns 4 parallel C-suite agents (CEO, CTO, CFO, COO). Each analyzes the business from their perspective using ALL available data. Produces unfiltered Hard Truths report. After user types YOLO, autonomously runs the business for a day using /loop."
