...
━━━ 1. [Contact Name] ━━━
 ...
 [Send] [Edit] [Read full thread] [Archive] [Skip]
...
- "Client outdated (405)" → rebuild from source: `cd /tmp && git clone https://github.com/auroracapital/wacli.git && cd wacli && go build -o /usr/local/bin/wacli ./cmd/wacli/`
...
━━━ 1. [Sender] — [Subject] ━━━
 ...
 [Send draft] [Edit draft] [Read full thread] [Archive] [Skip]
