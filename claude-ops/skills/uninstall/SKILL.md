---
name: uninstall
description: "This skill should be used when the user asks to \"/ops:uninstall\", \"run uninstall\", or \"use uninstall\". Completely remove claude-ops plugin, all stored credentials, cached files, shell exports, and MCP registrations. Confirms each step before deletion."
