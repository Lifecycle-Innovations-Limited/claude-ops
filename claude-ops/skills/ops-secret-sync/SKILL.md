...
## Real-world example: Example-Project Inngest case

This skill exists because of a recurring drift pattern:

| Project | Secret | Situation |
|---------|--------|-----------|
| example-project-api | `INNGEST_SIGNING_KEY` | Rotated in Doppler 2026-04-23 — GH secret was 24 days stale, CI failures started on 2026-05-17 |
...
Running `/ops:secret-sync --repo your-org/example-project-api --project example-project-api --config prd` would have surfaced `INNGEST_SIGNING_KEY` as DRIFTED 24+ days before CI failed.
