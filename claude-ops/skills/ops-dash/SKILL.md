---
name: ops-dash
description: "This skill should be used when the user asks to \"/ops:ops-dash\", \"run ops-dash\", or \"use ops-dash\". Interactive pixel-art command center dashboard. Visual business HQ with instant hotkey navigation to all ops commands, live status indicators, fire alerts, C-suite reports, settings, sharing, and FAQ."
