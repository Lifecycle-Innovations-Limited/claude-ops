...
If x-mcp returns 000/timeout: `launchctl kickstart -k gui/$UID/com.samrenders.mcp-proxy` and wait ~5s.
...
- **Proxy LaunchAgent**: `com.samrenders.mcp-proxy` (servers.json at `~/.claude/mcp-proxy/servers.json`)
