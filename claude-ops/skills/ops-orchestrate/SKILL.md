...
- **Linear**: `mcp__claude_ai_Linear__list_issues` for current sprint — in-progress and unstarted
...
TaskCreate({
  ...
  metadata: {
    project: "healify-api",
    repo: "Lifecycle-Innovations-Limited/healify-api",
    priority: "P1-revenue",
...
```
Agent({
  description: "Fix auth race condition in healify-api",
  model: "sonnet",
  isolation: "worktree",
