...
//   bucket: claude-account-leases-<AWS_ACCOUNT_ID>  (us-east-1, all public access
...
// (b) working AWS creds for account <AWS_ACCOUNT_ID>. Until the Mac is updated, EC2
// honoring leases is one-sided but harmless (EC2 yields; Mac is unaware).

import { spawnSync } from 'child_process';
import { hostname } from 'os';

const LEASE_BUCKET = process.env.CLAUDE_LEASE_BUCKET || 'claude-account-leases-<AWS_ACCOUNT_ID>';
