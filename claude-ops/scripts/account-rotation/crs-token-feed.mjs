...
const <USER>_EMAIL = process.env.CLAUDE_ROTATOR_<USER>_EMAIL || ['<OWNER_NAME>', 'gmail.com'].join('@');

// vault key (label || email) -> CRS account name
const CRS_NAME_BY_KEY = {
  'chairman@<OWNER_BRAND>.org': 'pool-chairman',
  'support@healify.ai': 'canary-support',
  <OWNER_BRAND>: 'pool-<OWNER_BRAND>-personal',
  '<OWNER_BRAND>-team': 'pool-<OWNER_BRAND>-team',
  '<WORK_EMAIL>': 'pool-<OWNER_BRAND>',
  [<USER>_EMAIL]: 'pool-<USER>',
  'info@auroracapital.nl': 'pool-aurora',
  '<WORK_EMAIL>': 'pool-foundation',
  'sponsors@<OWNER_BRAND>.org': 'canary-sponsors',
