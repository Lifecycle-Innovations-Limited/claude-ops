        ...
        if (submitted) {
          ...
          if (magicLink) {
            ...
            if (driver._authUrl) {
              ...
              // account-personal vs account-team), force an explicit org
...
async function rotate(targetEmail, opts = {}) {
  ...
  if (opts.noBrowser) {
    ...
    try {
      ...
      if (liveEmail) {
        ...
        // e.g. account-personal + account-team), prefer the entry whose
  ...
  // email, like account-personal vs account-team), confirm the live
