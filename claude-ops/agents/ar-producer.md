...
**🎛️ THE PLAN — producer moves** — specific, actionable fixes a producer can execute today. Not "make it brighter" — say _"open 2–3 dB of air shelf from 10 kHz, the spectrogram shows it dying above 15k"_. Reference exact timestamps from the structure read.
