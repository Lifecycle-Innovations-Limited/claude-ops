...
- **ops-accounts vision (plan only):** `docs/ops/OPS-ACCOUNTS-VISION.md` — future rename ops-rotate → multi-provider ops-accounts; cherry-pick balancer ideas; no fork in this release.
