---
name: ops-inbox
description: "Unified inbox across all channels. Shows unread messages and priority items."
triggers:
  - ops:inbox
  - inbox
  - unread messages
...
# OPS-INBOX — Unified inbox across all channels. Shows unread messages and priority items.
