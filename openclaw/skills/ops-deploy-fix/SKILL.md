---
name: ops-deploy-fix
description: "Auto-fix failed deployments. Post-merge build failure repair."
triggers:
  - ops:deploy-fix
  - deploy fix
  - fix deploy
  - ops_deploy_fix
category: Project & Eng
usable_tools:
  - exec
  - read
  - edit
...
# OPS-DEPLOY-FIX — Auto-fix failed deployments. Post-merge build failure repair.
