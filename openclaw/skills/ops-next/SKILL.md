---
name: ops-next
description: "Priority next action. Tells you what to do next based on all context."
triggers:
  - ops:next
  - what next
  - next action
...
# OPS-NEXT — Priority next action. Tells you what to do next based on all context.
