---
name: ops-yolo
description: "4 parallel C-suite agents (CEO, CTO, CFO, COO) for autonomous decisions."
triggers:
  - ops:yolo
  - yolo
  - autonomous
...
# OPS-YOLO — 4 parallel C-suite agents (CEO, CTO, CFO, COO) for autonomous decisions.
